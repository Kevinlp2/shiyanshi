...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="addSbbx.do">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="bxnum" data-validate="required:请输入报修数量"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="textarea " class="input w50" name="bxyy" data-validate="required:请输入维修原因"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
