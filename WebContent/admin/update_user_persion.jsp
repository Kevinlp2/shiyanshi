    ...
    <form method="post" class="form-x" action="updatePersionUser.do" >  
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="hidden" class="input w50"  disabled="disabled"  value="${user.uid }" name="uid" />
          <input type="text" class="input w50"  disabled="disabled"  value="${user.uname }" name="uname" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="text" class="input w50"  disabled="disabled"  value="${user.utype }" name="utype" />
          <div class="tips"></div>
        </div>
      </div>
